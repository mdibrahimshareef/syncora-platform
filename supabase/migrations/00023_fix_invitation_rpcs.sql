-- ------------------------------------------------------------------------------
-- MIGRATION: 00023_fix_invitation_rpcs
-- Purpose: 
-- 1. Make accept_invitation SECURITY DEFINER to bypass RLS during insert
-- 2. Update accept_organization_invitation and accept_team_invitation to verify email
-- 3. Update accept_organization_invitation and accept_team_invitation to return UUID
-- ------------------------------------------------------------------------------
